...
def Move(p,h,w,field):
  ...
  if down == 1 or down == 6: # PlotState.Unoccupied or PlotState.Enemy
    return 2 # Move.Down
  if left == 5 or left == 1 or left == 6: # PlotState.Visited or PlotState.Unoccupied or PlotState.Enemy
    return 3 # Move.Left
  if right == 1 or right == 6: # PlotState.Unoccupied or PlotState.Enemy
    return 4 # Move.Right
  if up == 5 or up == 1 or up == 6: # PlotState.Visited or PlotState.Unoccupied or PlotState.Enemy
    return 1 # Move.Up
  else:
